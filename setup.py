...
version = '2.5.0'
extra_compile_args = ['-Wformat=2', '-Wconversion', '-Werror=return-type', '-Wshadow', '-Wnull-dereference', '-Wpointer-arith', '-Wfloat-equal', '-Wunreachable-code', '-Wswitch-default', '-Wswitch-enum', '-Wall', '-Wextra', '-Wno-unused-parameter', '-Werror']
