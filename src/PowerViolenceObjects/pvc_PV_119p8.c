    ...
    format_d_return:
        ...
        case 5:
            if (precision > 0)
            {
                ...
                {
                    // _debug printf("len2541 = %d\n", len2541);
                    // _debug printf("s2541 = %s\n", s2541);
                    for (int i = 0; i <= precision; i++)
                    {
                        buffer[cnt++] = s2541[i];
                    }
                    // _debug printf("s2541[precision + 1] = %c\n", s2541[precision + 1]);
                ...
                {
                    if (len2541 == -1) buffer[cnt++] = '.';
                    // _debug puts(buffer);
                    // _debug printf("len2541 = %d\n", len2541);
                    // _debug printf("cnt = %zd\n", cnt);
                    for (int i = 0; i <= len2541; i++)
                    {
                        buffer[cnt++] = s2541[i];
                    }
                    if (len2541 == -1) len2541++;
                    // _debug puts(buffer);
                    // _debug printf("len2541 = %d\n", len2541);
                    // _debug printf("cnt = %zd\n", cnt);
                    while (len2541 < precision)
                    {
                        buffer[cnt++] = '0';
                    // _debug puts(buffer);
                        len2541++;
