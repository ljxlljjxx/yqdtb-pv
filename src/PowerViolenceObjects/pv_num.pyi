...
def get_overflow_function() -> None | Callable | str: ...
def set_overflow_function(value: None | Callable | str, /): ...
def call_overflow_function(): ...
def typestr_int(arg: str, /) -> int: ...
def typeint_str(arg: int, /) -> str: ...
def type_int(arg: type | PV_num, /) -> int: ...
def type_str(arg: type | PV_num, /) -> str: ...
def get_type(arg: int | str, /) -> type: ...
def typetype_type(arg1: int, arg2: int, /) -> int: ...
