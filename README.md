...
* This project also includes a simple implementation, named **src/PowerViolence/PowerViolence_simplified**, which does not fully implement the rules and can only allow one player and one computer to play against each other. This file is a **macOS** executable file.
